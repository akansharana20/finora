    ...
    auditLogs: [
      {
        ...
        user: { name: 'Sarah Connor', email: 'admin@acme.co.uk' },
      ...
      },
      {
        ...
        user: { name: 'David Wright', email: 'accountant@acme.co.uk' },
      ...
      },
      {
        ...
        user: { name: 'Emma Watson', email: 'user@acme.co.uk' },
  ...
  if (path === '/reports/dashboard') {
    ...
    return {
      ...
      data: {
        ...
        recentActivity: store.auditLogs,
      },
    };
  }
